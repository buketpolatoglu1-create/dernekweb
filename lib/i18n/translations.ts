...
export const translations: Record<Language, Record<string, string>> = {
  tr: {
    ...
    "why.card2.desc": "Sektörden profesyonellerle gençleri eşleştirerek 4 aylık mentorluk ve koçluk süreçleri yürütüyoruz.",
    ...
    "app.mentor.title": "Gönüllü Mentor & Koç Başvuru Formu",
    "app.mentor.sub": "Bilgi ve tecrübelerinizle gençlere rehberlik edin ve koçluk desteği sağlayın.",
    "app.mentor.desc": "Sektörel tecrübenizi 18-28 yaş aralığındaki gençlerle paylaşarak onların kariyer planlamalarına ışık tutabilirsiniz. Gönüllü mentorluk ve koçluk dönemlerimizde yer alarak gençlerin yol arkadaşı olun. Destek vermek istediğiniz alan olarak mentorluk ve/veya koçluk seçebilirsiniz (her ikisini de işaretleyebilirsiniz). Mentorlukta 4 ay destek vermenizi bekliyoruz. Koçluk desteği için ICF onaylı koç olmanız ve min. 125 saat koçluk yapmış olmanız gerekmektedir. (Gönüllü mentorluk başvurularında özel sektör veya kamu kurumlarında en az 15 yıl yönetim pozisyonu deneyimi şartı aranmaktadır.)",
    "app.mentor.btn": "Gönüllü Mentor & Koç Başvuru Formu",
  ...
  en: {
    ...
    "why.card2.desc": "We run 4-month mentorship and coaching programs by matching young people with industry professionals.",
    ...
    "app.mentor.title": "Volunteer Mentor & Coach Application Form",
    "app.mentor.sub": "Guide young people with your knowledge, experience, and coaching support.",
    "app.mentor.desc": "Share your industry experience with young people aged 18-28 to illuminate their career planning. Become a companion to youth by participating in our volunteer mentoring and coaching periods. You can choose mentoring and/or coaching as your area of support (you can select both). We expect you to support for 4 months in mentoring. For coaching support, you must be an ICF-certified coach and have completed a minimum of 125 hours of coaching. (Volunteer mentoring applications require a minimum of 15 years of management position experience in the private or public sector.)",
    "app.mentor.btn": "Volunteer Mentor & Coach Application Form",
